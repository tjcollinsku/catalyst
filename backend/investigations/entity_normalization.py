...
Why normalization matters:
    "EXAMPLE, JOHN A."  and  "John A. Example"  and  "john example"
...
def _uninvert_name(raw: str) -> str:
    ...
    Examples:
        "EXAMPLE, JOHN A."    →  "JOHN A. EXAMPLE"
        "INSIDER, MARY JO"   →  "MARY JO INSIDER"
        "John A. Example"     →  "John A. Example"   (unchanged)
    """
...
def normalize_person_name(raw: str) -> str:
    ...
    Examples:
        "EXAMPLE, JOHN A."        →  "john a example"
        "John A. Example"         →  "john a example"
        "Jane Doe"    →  "mary jo insider"
        "O'Brien, Patrick"      →  "patrick o'brien"
        "Jean-Paul Doe Jr."  →  "jean-paul doe"
    """
...
# "Example Charity Ministries, Inc." and "Example Charity Ministries" should match.
...
def normalize_org_name(raw: str) -> str:
    ...
    Examples:
        "Example Charity Ministries, Inc."    →  "example charity ministries"
        "Example Charity Ministries"          →  "example charity ministries"   ← same!
        "Example AG Management, LLC"    →  "example ag management"
        "The Doe Foundation"       →  "doe foundation"
    """
    if not raw or not raw.strip():
        return ""
