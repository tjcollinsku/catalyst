...
#
# REAL-WORLD EXAMPLE for each rule (from the Do Good case):
#   SR-014: 6712 Olding Rd → charity + Jay Homan + JZL Partners
#   SR-015: Charity buys from Meier → flips to Winner (Jay's uncle sold it)
#   SR-016: Jay, Karen, Lester, Ron J, Albers — all family
#   SR-017: Farm Credit blanket lien on JZL Partners at charity address
#   SR-018: Meier land → Do Good → Winner in 5 days
#   SR-019: Do Good Inc + Do Good Real Estate LLC both formed 2019
#   SR-020: Darke + Mercer + Shelby + Hardin counties
#   SR-021: 2019 revenue spike ($1.62M contributions in year 2)
#   SR-022: 14 Facebook friends match obituary surnames
#   SR-023: Homan Ag Mgmt LLP formed 10 days before firehouse buy
#   SR-024: Charity buys from Meier (family) → gives to Winner (insider)
# ===========================================================================
...
# have caught 6712 Olding Rd being shared by the charity, Jay Homan, and
# JZL Homan Partners.
#
# HOW IT WORKS:
...
#
# In the Do Good case, this catches:
#   - Charity buys from Poeppelman → Poeppelman's son gets property from charity
#   - Charity buys from Meier (Jay's uncle) → flips to Winner (insider)
#   - Charity gives lot to Albers (Jay's uncle's family)
#   - Charity gives lot to Mescher (Farm Credit officer's family)
# ---------------------------------------------------------------------------
...
# Catches: Meier → Do Good → Winner in 5 days.
# ---------------------------------------------------------------------------
...
# within any 90-day window. The Do Good case had the charity, Do Good Real
...
# In the Do Good case: $1.62M in contributions appeared in Year 2.
# ---------------------------------------------------------------------------
...
# Catches: Homan Ag Mgmt LLP formed 10 days before firehouse buy.
# ---------------------------------------------------------------------------
...
#
# Example: Do Good marked "No" on Line 28 (transactions with interested
# persons). But our database has Relationship records proving Karen Homan
# (president) is married to Jay Homan, whose uncle Nick Meier sold land
...
# Baumer Construction built everything.
# ---------------------------------------------------------------------------
