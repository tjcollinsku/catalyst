...
Usage:
    ...
    records = fetch_pub78()
    results = search_pub78("Do Good Ministries", records, state="OH")
...
def search_pub78(
    ...
    Example:
        records, warning = fetch_pub78()
        result = search_pub78("Do Good Ministries", records, warning, state="OH")
...
def search_eo_bmf(
    ...
    Example:
        records, warning = fetch_eo_bmf(EoBmfRegion.STATE_OH)
        result = search_eo_bmf("Do Good Ministries", records, warning, state="OH")
        for r in result.matches:
...
def search_ohio_nonprofits(
    ...
    Example:
        result = search_ohio_nonprofits("Do Good Ministries")
        for r in result.matches:
