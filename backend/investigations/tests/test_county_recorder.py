...
def _deed_text(
    ...
    grantor="HOMAN, DAVID A",
    grantee="HOMAN PROPERTIES LLC",
...
class GetSearchUrlTests(unittest.TestCase):
    ...
    def test_cloud_search_with_name_instructions_mention_name(self):
        ...
        result = get_search_url(OhioCounty.OTTAWA, grantor_grantee="HOMAN")
...
class GrantorGranteeTests(unittest.TestCase):
    def test_label_format_grantor(self):
        ...
        self.assertIn("Homan", result.grantor)
...
class TitleCaseNameTests(unittest.TestCase):
    def test_all_caps_converted(self):
        result = _title_case_name("HOMAN DAVID A")
        self.assertEqual(result, "Homan David A")

    def test_llc_preserved(self):
        result = _title_case_name("HOMAN PROPERTIES LLC")
        self.assertEqual(result, "Homan Properties LLC")
