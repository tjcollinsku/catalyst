...
class OrganizationType(models.TextChoices):
    ...
    HOLDING_COMPANY = "HOLDING", "Holding Company"
...
class FinancialInstrument(UUIDPrimaryKeyModel):
    ...
    # In the Do Good case, Farm Credit filed blanket liens covering
...
# ──────────────────────────────────────────────────────────────────────
#
# WHY: In the Do Good case, 6712 Olding Rd appears on the charity's filings,
# Jay Homan's personal records, AND Farm Credit UCC filings. The old schema
...
# ──────────────────────────────────────────────────────────────────────
#
# WHY: In the Do Good case, Jay Homan (charity officer) is the SON of
# Ronald Homan Sr. (deceased signer) and BROTHER of Ron Jr. He's also
...
# ──────────────────────────────────────────────────────────────────────
#
# WHY: The Poeppelman insider swap works like this:
#   1. Charity buys property from Poeppelman (charity = buyer)
#   2. Same property later transferred to Poeppelman-connected entity
...
class TransactionChain(UUIDPrimaryKeyModel):
    ...
    Example: The "Winner insider swap" chain would contain:
      Link 1: Charity buys 5765 Burkettsville Rd (2021-06-28)
      Link 2: Winners use property as charity-connected insiders
    ...
    label = models.CharField(
        max_length=255,
        help_text="Human-readable label, e.g. 'Poeppelman → Do Good swap (SR-068)'",
    )
...
class TransactionChainLink(UUIDPrimaryKeyModel):
    ...
    role_description = models.CharField(
        max_length=255, blank=True, default="",
        help_text="E.g. 'Charity purchases from Poeppelman' or 'Insider receives property'",
    )
...
# ──────────────────────────────────────────────────────────────────────
#
# WHY: In the Do Good case, Facebook friend lists revealed 14 direct
# obituary matches between Jay Homan's friends and people named in
