...
- **Run Example Township/Example Charity case end-to-end** — create case, bulk upload ~100 docs in two batches, watch pipeline, create 4 referrals (FBI, State AG, IRS, FCA), generate memo
