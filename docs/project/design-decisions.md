...
**Context:** In forensic work, "John A. Homan" and "John Homan" might be the same person, or they might be father and son. An automated system cannot make that judgment call safely. Fuzzy candidates are surfaced with similarity scores for the investigator to review.
