...
- Arrowhead: Direction of relationship (Brunswick → Do Good = officer direction)
...
│                                                               │
│  Multiple transactions between Do Good Inc and entities       │
│  controlled by the same officers.                             │
│                                                               │
│  Evidence: FY2019_990.pdf, FY2020_990.pdf, Deed_123Main.pdf  │
│  Entities: Jay Brunswick, Do Good Inc, Osgood Fire Co         │
│                                                               │
...
│  between Do Good In His Name Inc and entities controlled...   │
│  [Read more →]                                                │
│                                                               │
...
┌──────────── AI Assistant ──────── ✕ ─┐
│                                       │
│  🤖 I'm analyzing the Do Good case.  │
...
|------|-----------|--------|------------|
| D3 graph performance with 100+ nodes | Medium | High | Implement node clustering for large graphs. Virtualize if needed. Test with Do Good case data (15+ entities). |
